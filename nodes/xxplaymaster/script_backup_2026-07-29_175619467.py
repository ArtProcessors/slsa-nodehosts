...
class MasterControl:
  ...
  def __init__(self, name, memberNoun, paramTitle, gainPattern, mutePattern,
               volumeEvent, muteEvent, inSyncEvent, defaultMin, defaultMax):
    ...
    self.volumeEvent = volumeEvent
    self.muteEvent = muteEvent
    self.inSyncEvent = inSyncEvent
  ...
  def init(self, spec, minGain, maxGain):
    ...
    for member in self.members:
      lookup_local_event(self.gainPattern % member).addEmitHandler(self.recompute)
      lookup_local_event(self.mutePattern % member).addEmitHandler(self.recompute)
...
_zoneMaster = MasterControl("Master Volume", "zone", "Master zones",
                            ...
                            local_event_MasterVolume, local_event_MasterMute, local_event_MasterZonesInSync,
...
_outputMaster = MasterControl("Master Output Volume", "output", "Master outputs",
                              ...
                              local_event_MasterOutputVolume, local_event_MasterOutputMute, local_event_MasterOutputsInSync,
