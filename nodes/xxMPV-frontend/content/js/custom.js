/*
 * mpv Playlist - frontend UI (drives the engine node via mirrored actions/events).
 *
 * Page-scoped: this tab's markup lives under a single root, <... class="mpv-root">
 * (see content/index.xml). Every DOM read/write is routed through root() so the
 * injected playlist editor stays inside this page and can coexist with sibling
 * <page> tabs in a larger Frontend/Mk2 gallery dashboard. The poller is inert when
